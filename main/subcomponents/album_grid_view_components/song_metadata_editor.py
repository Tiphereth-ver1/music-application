...
class SongMetadataEditor(QDialog):
    def __init__(self, song : Song, parent=None):
        ...
        self._reload_preview(self.song.get_art())
        self.layout.addWidget(self.cover_button, alignment = Qt.AlignHCenter | Qt.AlignVCenter)
        ...
        for metadata in METADATA_FIELDS:
            ...
            field.set_value(self.song.get_info(metadata))
